...
#Buttons
B1=Button(Root,text="View All",width=12,command=view)
B1.place(x=280, y=60)
B2=Button(Root,text="Search Entry",width=12,command=search)
B2.place(x=280,y=90)
B3=Button(Root,text="Add Entry",width=12,command=add)
B3.place(x=280,y=120)
B4=Button(Root,text="Delete Selected",width=12,command=delete)
B4.place(x=280,y=150)
B5=Button(Root,text="Update Selected",width=12,command=update)
